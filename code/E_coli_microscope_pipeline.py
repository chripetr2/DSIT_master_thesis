...
exprs_path = "/home/cp/Desktop/torun"
save_path ='/home/cp/Desktop/results'
for exp in os.listdir(exprs_path):
    ...
    for num,img_name in tqdm(enumerate(np.sort(imgs_path))):
        ...
        if img_path.split('.')[-1] not in ['jpg','png','tif','tiff']:continue
        ...
        # original = exposure.equalize_hist(org_img)*255;
